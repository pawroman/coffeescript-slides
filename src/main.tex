...
\slide{(Quick) syntax tutorial: default arguments}
...
\slide{(Quick) syntax tutorial: strings}
...
\slide{(Quick) syntax tutorial: more on strings and function calling}
...
\slide{(Quick) syntax tutorial: iteration, comprehensions}
...
\slide{(Quick) syntax tutorial: iteration, comprehensions, pt.2}
...
\slide{Classes: @ binding via =>}
    \coffee
    # this example begs for something simpler...
